...
public class CellWriteListener implements ExcelCellWriteListener {
    @Override
    public void completeCell(Sheet sheet, Row row, Cell cell, ExcelFieldProperty excelFieldProperty, int index, int colIndex, RowType rowType) {
        // 只对正文数据行操作
    ...
    @Override
    public Object assignmentBefore(Sheet sheet, Row row, Cell cell, ExcelFieldProperty property, int index, int colIndex, RowType rowType, Object value) {
